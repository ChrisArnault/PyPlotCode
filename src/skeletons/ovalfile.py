...
targets = [
    {"name": "ex1_read_image",
     "command": "python ex1_read_image.py -b ../../data/fits/common.fits"},
    {"name": "ex2_background",
     "command": "python ex2_background.py -b ../../data/fits/common.fits"},
    {"name": "ex3_clusters",
     "command": "python ex3_clusters.py -b ../../data/fits/common.fits"},
    {"name": "ex4_stars", "command": "python ex4_stars.py -b ../../data/fits/common.fits"},
    {"name": "ex5_show_stars",
     "command": "python ex5_show_stars.py -b ../../data/fits/common.fits"},
    ...
    {"name": "stud_lib_args6",
     "command": "unset DATAPATH ; python lib_args.py ../data/specific.fits"},
    {"name": "stud_lib_args7", "command": "unset DATAPATH ; echo '' | python lib_args.py"},
    {"name": "stud_lib_args8",
     "command": "unset DATAPATH ; echo 'specific' | python lib_args.py"},
]

# filters

run_filters_out = [{"name": "wcs",
                    "re": "^(WARNING:|warning:|Defunct|this form of).*$",
                    "apply": "ex(4|5)%"},
                   ]
