...
#for ex in ex1_read_image ex2_background ex3_new_clusters ex4_coordinates ex5_find_stars
#do
    ...
    do
        ...
        #cp -f ${pyplotcode}/data/md5/ex3_new_clusters.NPAC${txt}.md5 ${student}/data/NPAC${txt}/ex3.md5
